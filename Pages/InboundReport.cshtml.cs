...
{
    public class InboundReportModel : DI_BasePageModel
    {
        public string url;
        ...
        public async Task OnGetAsync()
        {
            ...
            var clientDashboard = _applicationUserDataAccessLayer.GetClientDashboardByClientIdAndDashboardType(user.ClientId, "inbound");

            //var username = UserManager.GetUserName(User);
            //ProgrammaticFilter programmaticFilter = ProgrammaticFilteringService.getProgrammaticFilter(username);
            //programmaticFilter.EmbedId = "68o6z";
            ...
            {
                filters = sbFilters.ToString().Remove(sbFilters.Length - 1, 1) + ",{\"column\":\"CAMPAIGN_TYPE\",\"operator\": \"EQUALS\",\"values\": [\"Inbound\"]}" + "]";
            }
